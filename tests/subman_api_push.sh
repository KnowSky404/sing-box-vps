...
export CURL_ARGS_FILE CURL_RESPONSE_BODY CURL_RESPONSE_STATUS
...
if [[ "${curl_args}" != *"https://subman.example.com/api/nodes/by-key/sing-box-vps:edge-1:vless-reality"* ]]; then
