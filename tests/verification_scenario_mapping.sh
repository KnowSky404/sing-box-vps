...
assert_scenarios "fresh_install_vless,reconfigure_existing_install,legacy_takeover_export,fresh_install_anytls,runtime_smoke" install.sh
assert_scenarios "fresh_install_vless,reconfigure_existing_install,legacy_takeover_export,fresh_install_anytls,runtime_smoke" configs/example.json
assert_scenarios "runtime_smoke" utils/common.sh
assert_scenarios "runtime_smoke,uninstall_and_reinstall" uninstall.sh
assert_scenarios "fresh_install_vless,reconfigure_existing_install,legacy_takeover_export,fresh_install_anytls,runtime_smoke,uninstall_and_reinstall" install.sh tests/uninstall_purge_removes_runtime_artifacts.sh
